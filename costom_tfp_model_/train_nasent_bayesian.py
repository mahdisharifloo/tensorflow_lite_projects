...
# bottleneck_features_test = nasnet.predict_generator(val_generator, predict_size_train) 

# np.save('bottleneck_features_nasnet_train.npy', bottleneck_features_train)
# np.save('bottleneck_features_nasnet_test.npy', bottleneck_features_test)
...
train_data = np.load('bottleneck_features_nasnet_train.npy') 
test_data = np.load('bottleneck_features_nasnet_test.npy') 
