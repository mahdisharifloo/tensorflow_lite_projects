...
def im_lite_loader(im_path):
    input_image = tf.keras.preprocessing.image.load_img(im_path)
    input_image = tf.keras.preprocessing.image.img_to_array(input_image)
    #Reshape input_image 
    input_image = tf.keras.preprocessing.image.smart_resize(input_image,(input_shape[1],input_shape[2]))
